    ...
    <section id="skills" class="section py-24 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                ...
                >
                    <div class="flex items-center justify-center w-16 h-16 bg-light-cyan rounded-2xl mb-6 mx-auto">
                    ...
                    <div class="space-y-5">
                        ...
                        >
                            <div class="flex justify-between mb-2">
                                ...
                                <span class="text-chinese-bronze">
                                    {{ item.level }}
                                </span>
                            </div>
                            <div class="skill-bar">
            ...
            <div class="mt-12">
                ...
                <div class="flex flex-wrap justify-center gap-3">
                    <span
                        ...
                        :key="`tag-${tag.name}`"
                        :class="`tag bg-${tag.color}/10 text-${tag.color}`"
                    >
                        {{ tag.name }}
                    </span>
                </div>
